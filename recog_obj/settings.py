"""
Django settings for recog_obj project.
...
SECRET_KEY = 'django-insecure-e4zazgk8)$01f11!a9v@@e*u#xf=rq&wk*v&0j&ld0kz5a(ufp'
...
WSGI_APPLICATION = 'recog_obj.wsgi.application'
...
USE_TZ = True
ASGI_APPLICATION = 'recog_obj.asgi.application'
